...
========================================================================
Code for SUBS exercise using BioPython Package
========================================================================
...
def Biopython_encontrar_motivo():
    ...
    # método nt_search retorna uma lista com a primeira posição sendo o motivo
    # e as demais posições sendo os índices de ocorrência do motivo na sequência
    matches = SeqUtils.nt_search(str(dna), motivo)
    resultado = [i + 1 for i in matches[1:]]

    return resultado


if __name__ == "__main__":
    resultado = Biopython_encontrar_motivo()
